...
import {
  ...
  addItem,
  UpdateItem,
} from "../../services/ModuleFormatterService";
import GridView from "../common/GridView";
import { Item } from "devextreme-react/form";
import { Form } from "devextreme-react/data-grid";

class ModuleFormatter extends Component {
  state = {
    data: [],
  };
  ...
  render() {
    return (
      <GridView
        ...
        name="ModuleFormatters"
        popUpTitle="ModuleFormatter Information"
...
export default ModuleFormatter;
